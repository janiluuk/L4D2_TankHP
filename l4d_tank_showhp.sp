...
public Plugin myinfo =
{
	...
	author = "Alex Dragokas, Yani",
	description = "Show tank's HP on the center screen when you are shooting him",
	version = PLUGIN_VERSION,
	url = "https://forums.alliedmods.net/showthread.php?p=2744904"
};
...
/*
	...
	1.3 (27-Dec-2023)
	 - Fixed to show HP as a hint text for better visibility
...
public void Event_OnPlayerHurt(Event event, const char[] name, bool dontBroadcast)
{
	...
	{
		PrintHintText(attacker, "HP: |%s|  [%d / %d]  %N", g_sScale[idx], nowHP, maxHP, tank);
	}
	else {
		char bar[128];
